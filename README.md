...
```
bash <(curl -s https://raw.githubusercontent.com/Ramin-Setoodehnia/utunnel/refs/heads/main/install_utunnel.sh --ipv4)
```

🤖 نصب ربات تلگرام مونیتورینگ

```
bash <(curl -s https://raw.githubusercontent.com/Ramin-Setoodehnia/utunnel/refs/heads/main/MonitorBotinstall.sh --ipv4)
```
پس از اجرا:
